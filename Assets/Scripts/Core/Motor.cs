...
public class Motor : Registry
{
    [SerializeField] CameraRig _registeredRig;
    [SerializeField] Transform _model;
    [SerializeField] bool _physicsBasedMovement = false;
    ...
    {
        Pretick();
        Loop<MotorModule>((module) => module?.DoLateUpdate());
    }

    void TickModules()
    {
        Loop<MotorModule>((module) => module?.DoUpdate());
    }

    void Pretick()
    {
        Loop<StateSetterModule>((module) => module?.DoUpdate());
    }
